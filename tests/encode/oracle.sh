...
CASES=(
  ...
  "cD_img_tga|-cD -t1|pic.tga"
  "cD_img_mix|-cD -t1 -sn|gray.tif a.txt pic.tga tone.wav gray.pgm"
  "cD_media|-cD -t1 -sn|tone.wav p2.txt voice8.wav raw16.pcm"
  "cD_dotdir|-cD -t1 -r|."
  "cD_default|-cD|b.bin"
  "cD_m1m|-cD -t1 -m8m|p12.bin"
  "cn_m256k|-cn -t1 -m256k|p12.bin"
  "cf_m300k|-cf -t1 -m300k|p12.bin"
  "cF_m70m|-cF -t1 -m70m|p12.bin"
  "cd_m1m|-cd -t1 -m1m|p12.bin"
  "cD_m1500k|-cD -t1 -m1500k|p12.bin"
  "cd_one|-cd|a.txt"
  "cD_one|-cD|a.txt"
  "co_one|-co|a.txt"
  "cO_one|-cO|a.txt"
