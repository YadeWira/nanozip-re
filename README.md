...
raw-store and pure-literal chunks (~92% of a varied corpus — incl. images, audio,
video, executables) and bridge only on chunks that use the text-pipeline param14
(tt08) or exe sub-methods; `-co`/`-cO` (large) bridge on the virtual-stream LZ
