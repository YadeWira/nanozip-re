...
- [ ] **Task #13**: Port prefilter+arith path (`uVar9 & 7 == 4`, `FUN_080a5330` ~700 LOC + callees). Covers high-compression-level `-cf` blocks. Estimated 3–5 sessions.
...
- [ ] **cm native decoder**: reuses the same context mixer as lzhd.
